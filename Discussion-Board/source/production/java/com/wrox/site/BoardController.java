...
public class BoardController
{
    ...
    public String deleteDiscussion(Map<String, Object> model)
    {
        model.put("discussionDelete", new DiscussionForm());
    ...
    public View deleteDiscussion(DiscussionForm form)
    {
        Discussion discussion = new Discussion();
        discussion.setDelete(form.getDelete());
         this.discussionService.saveDiscussion(discussion);
